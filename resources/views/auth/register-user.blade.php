  ...
  <div class="register-container">
    ...
    <div class="brand-panel">
      <div class="brand-content">
        ...
        <p class="brand-tagline">Daftar sekarang dan nikmati kemudahan memesan roti favorit Anda</p>

        <!-- <div class="benefits-list">
          <div class="benefit-item">
            <span class="benefit-icon">✨</span>
            <span class="benefit-text">Akses ke semua menu eksklusif</span>
          </div>
          <div class="benefit-item">
            <span class="benefit-icon">🛒</span>
            <span class="benefit-text">Simpan keranjang belanja</span>
          </div>
          <div class="benefit-item">
            <span class="benefit-icon">📦</span>
            <span class="benefit-text">Lacak riwayat pesanan</span>
          </div>
          <div class="benefit-item">
            <span class="benefit-icon">🎁</span>
            <span class="benefit-text">Dapatkan penawaran spesial</span>
          </div>
        </div> -->
      </div>
    </div>
    ...
    <div class="form-panel">
      <div class="register-card">
          ...
          <div class="form-group">
            ...
            <div class="input-group-icon">
              ...
              <input type="tel" class="form-control @error('no_telepon') is-invalid @enderror" name="no_telepon"
                placeholder="08xxxxxxxxxx" required value="{{ old('no_telepon') }}">
            </div>
        ...
        <div class="form-footer">
          <p class="mb-2">Sudah punya akun? <a href="{{ route('user.login') }}">Masuk</a></p>
